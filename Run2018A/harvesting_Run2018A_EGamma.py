...
# with command line options: step4 --data --filetype DQM --conditions 106X_dataRun2_v20 -s HARVESTING:@rerecoCommon --customise_commands=process.DQMStore.saveByLumi = cms.untracked.bool(True) --era Run2_2018 --scenario pp --filein file:RECO_RAW2DIGI_L1Reco_RECO_ALCA_EI_PAT_DQM_inDQM.root --python_filename=harvesting_Run2018A_EGamma.py --no_exec
