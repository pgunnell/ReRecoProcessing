...
process.ALCARECOStreamHcalCalIsolatedBunchFilter = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('pathALCARECOHcalCalIsolatedBunchFilter')
    ),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('ALCARECO'),
        filterName = cms.untracked.string('HcalCalIsolatedBunchFilter')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('HcalCalIsolatedBunchFilter.root'),
    outputCommands = cms.untracked.vstring(
        'drop *', 
        'keep *_hbhereco_*_*', 
        'keep *_ecalRecHit_*_*', 
...
process.SKIMStreamJetHTJetPlusHOFilter = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('JetHTJetPlusHOFilterPath')
    ),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('RAW-RECO'),
        filterName = cms.untracked.string('JetHTJetPlusHOFilter')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('JetHTJetPlusHOFilter.root'),
    outputCommands = cms.untracked.vstring( (
        'drop *', 
        'drop *', 
        'keep  FEDRawDataCollection_rawDataCollector_*_*', 
...
process.ALCARECOEventContent.outputCommands.extend(process.OutALCARECOHcalCalIsolatedBunchFilter_noDrop.outputCommands)
