...
# with command line options: step4 --data --filetype DQM --conditions 106X_dataRun2_v20 -s HARVESTING:@rerecoSingleMuon --customise_commands=process.DQMStore.saveByLumi = cms.untracked.bool(True) --era Run2_2018 --scenario pp --filein file:RECO_RAW2DIGI_L1Reco_RECO_ALCA_EI_PAT_DQM_inDQM.root --python_filename=harvesting_Run2018A_SingleMuon.py --no_exec
...
process.DQMHarvestLumi_step = cms.Path(process.DQMHarvestLumi)
