...
# with command line options: step4 --data --filetype DQM --conditions 106X_dataRun2_v20 -s HARVESTING:@rerecoCommon --era Run2_2018 --scenario pp --filein file:RECO_RAW2DIGI_L1Reco_RECO_ALCA_EI_PAT_DQM_inDQM.root --python_filename=harvesting_Run2018A_MET.py --no_exec
