...
process.ALCARECOStreamHcalCalHEMuonFilter = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('pathALCARECOHcalCalHEMuonFilter')
    ),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('ALCARECO'),
        filterName = cms.untracked.string('HcalCalHEMuonFilter')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('HcalCalHEMuonFilter.root'),
    outputCommands = cms.untracked.vstring(
        'drop *', 
        'keep *_hbhereco_*_*', 
        'keep *_ecalRecHit_*_*', 
...
process.ALCARECOStreamHcalCalHO = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('pathALCARECOHcalCalHO')
    ),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('ALCARECO'),
        filterName = cms.untracked.string('HcalCalHO')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('HcalCalHO.root'),
    outputCommands = cms.untracked.vstring(
        'drop *', 
        'keep HcalNoiseSummary_hcalnoise_*_*', 
...
process.SKIMStreamMuTau = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('MuTauPath')
    ),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('USER'),
        filterName = cms.untracked.string('MuTau')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('MuTau.root'),
    outputCommands = cms.untracked.vstring(
        'drop *', 
        'drop *', 
...
process.SKIMStreamMuonPOGSkim = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring(
            'MuonPOGSkimTrackPath', 
            'MuonPOGSkimSTAPath'
        )
    ),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('USER'),
        filterName = cms.untracked.string('MuonPOGSkim')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('MuonPOGSkim.root'),
    outputCommands = cms.untracked.vstring(
        'drop *', 
        'keep *_TriggerResults_*_*', 
        'keep *_gmtStage2Digis_Muon_*', 
...
process.SKIMStreamZMu = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
    ...
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('ZMu.root'),
    outputCommands = cms.untracked.vstring( (
        'drop *', 
        'drop *', 
        'keep  FEDRawDataCollection_rawDataCollector_*_*', 
...
process.ALCARECOEventContent.outputCommands.extend(process.OutALCARECOHcalCalHO_noDrop.outputCommands)
process.ALCARECOEventContent.outputCommands.extend(process.OutALCARECOHcalCalHEMuonFilter_noDrop.outputCommands)
...
process.dqmoffline_6_step = cms.EndPath(process.DQMOfflineLumi)
process.dqmoffline_7_step = cms.EndPath(process.DQMOfflineL1TMuon)
process.dqmoffline_8_step = cms.EndPath(process.DQMOfflineL1TEgamma)
...
process.ALCARECOStreamHcalCalHEMuonFilterOutPath = cms.EndPath(process.ALCARECOStreamHcalCalHEMuonFilter)
process.ALCARECOStreamHcalCalHOOutPath = cms.EndPath(process.ALCARECOStreamHcalCalHO)
